...
#define WIFISSID "JESSENIA" // Put your WifiSSID here
#define PASSWORD "rosita200@" // Put your wifi password here
#define TOKEN "BBFF-futcmgmyVLvU4ZR4jEpRQox0KecPZc" // Put your Ubidots' TOKEN
#define DEVICE_LABEL "ESP8266_Vital_Monitor" // Put the device label
#define VARIABLE_LABEL_1 "bpm" // Put the variable label
#define VARIABLE_LABEL_2 "oxigeno" // Put the variable label
#define MQTT_CLIENT_NAME "EL_ESP8266" // MQTT client Name, put a Random ASCII
PulseOximeter pox;
